 ...
 * 2018-03-23T11:18:27.828-03:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/C:/users/desenvolvimento/git/estoquews/src/EstoqueWSService.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/users/desenvolvimento/git/estoquews/src/EstoqueWSService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/users/desenvolvimento/git/estoquews/src/EstoqueWSService.wsdl");
        }
        WSDL_LOCATION = url;
    }
